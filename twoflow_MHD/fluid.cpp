	...
	for (int i = 0; i < nz; i++)
	{
		...
		{		
			if (btype[i][j] == 1)
			{
				...
				//{
				//	Qz = 0.23 * abs(U_bar2[i + 1][j].u1 - 2 * U_bar2[i][j].u1 + U_bar2[i - 1][j].u1) / abs(U_bar2[i + 1][j].u1 + 2 * U_bar2[i][j].u1 + U_bar2[i - 1][j].u1);
				//}
				//if (abs(U_bar2[i][j + 1].u1 + 2 * U_bar2[i][j].u1 + U_bar2[i][j - 1].u1) != 0)
				//{
				//	Qr = 0.23 * abs(U_bar2[i][j + 1].u1 - 2 * U_bar2[i][j].u1 + U_bar2[i][j - 1].u1) / abs(U_bar2[i][j + 1].u1 + 2 * U_bar2[i][j].u1 + U_bar2[i][j - 1].u1);
				//}
